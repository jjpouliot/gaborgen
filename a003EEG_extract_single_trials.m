...
participantIDs = [110,111,112,113,114,115,116,117,118,119120,121,122,123,125,126,127,128,129,130];
epochMs = [0 2000];
sampleRateHz = 500;
...
for participantIndex = 1:length(participantIDs)
    ...
    for j = 1:length(currentParticipantDirectories)
        ...
        for trialIndex = 1:length(cleanTrialNumber)
            ...
            rawTimeseriesName = ...
                ['rawChanTime_particpant' num2str(participantID) '_trial' ...
            ...
            SlidingWindowTimeseriesName = ...
                ['slidingWindow_ChanTime_particpant' num2str(participantID) '_trial' ...
                num2str(currentTrialNumber) '_condition'...
                ureventTable.type{eventInd(trialIndex)} ...

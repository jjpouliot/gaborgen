...
//   array[n_beta] vector[(n_roi*(n_roi-1))%/%2] rho_z_tau_betas_raw;
  ...
  real<lower=0> csp_rho_raw;
  real<lower=0> gs1_rho_raw;
  real<lower=0> gs2_rho_raw;
  real<lower=0> gs3_rho_raw;
  real<lower=0> shock_rho_raw;
  real<lower=0> csp_alpha_raw;
  real<lower=0> gs1_alpha_raw;
  real<lower=0> gs2_alpha_raw;
  real<lower=0> gs3_alpha_raw;
  real<lower=0> shock_alpha_raw;
  real<lower=0> csp_sigma_raw;
  real<lower=0> gs1_sigma_raw;
  real<lower=0> gs2_sigma_raw;
  real<lower=0> gs3_sigma_raw;
  real<lower=0> shock_sigma_raw;
}
...
transformed parameters {
  ...
  real csp_rho = csp_rho_raw * 7;
  real gs1_rho = gs1_rho_raw * 7;
  real gs2_rho = gs2_rho_raw * 7;
  real gs3_rho = gs3_rho_raw * 7;
  real shock_rho = shock_rho_raw  * 7;
  real csp_alpha = csp_alpha_raw * .5;
  real gs3_alpha = gs3_alpha_raw * .5;
  real gs1_alpha = gs1_alpha_raw * .5;
  real gs2_alpha = gs2_alpha_raw * .5;
  real shock_alpha = shock_alpha_raw * .5;
  real csp_sigma = csp_sigma_raw * .5;
  real gs1_sigma = gs1_sigma_raw * .5;
  real gs2_sigma = gs2_sigma_raw * .5;
  real gs3_sigma = gs3_sigma_raw * .5;
  real shock_sigma = shock_sigma_raw * .5;

functions {
  ...
  for (r in 1:n_roi) {
    ...
    lp_mvn += multi_normal_lpdf(bold_censored[,r] | Mu[r], Cov_censor[r]);
...
parameters {
  ...
  array[n_par, n_roi] real <lower =0> sigma_raw;
...
generated quantities {
  ...
  array[n_roi] real mu_sigma;
  array[n_roi] real mu_delta;
  array[n_roi] real mu_rho_time;

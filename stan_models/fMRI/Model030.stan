...
transformed parameters {
  ...
  for (r in 1:n_roi) {
    ...
    betas_z[r][csp_beta_indices];
betas_z[r][gs1_beta_indices];
betas_z[r][gs2_beta_indices];
betas_z[r][gs3_beta_indices];
betas_z[r][shock_beta_indices];
...
//   shock_rho ~ lognormal(log(8), .5);
  ...
  for(r in 1:n_roi) {
    ...
    mu_beta_csp ~ std_normal();
    mu_beta_gs1 ~ std_normal();
    mu_beta_gs2 ~ std_normal();
    mu_beta_gs3 ~ std_normal();
  }

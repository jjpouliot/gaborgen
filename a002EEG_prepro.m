...
EEG_prep4ICA([123],500,[3 40],'/home/andrewf/Research_data/EEG/Gaborgen24_EEG_fMRI');

%%% manual step: check which channels should not be included in ICA

% Why does it remove artifacts and then do ICA to remove the artifacts
% again? - Andrew
...
% How do you manually check ICs? Andrew

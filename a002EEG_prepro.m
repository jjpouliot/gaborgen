...
%116 seem to lose  F4, C4, Fz at 1862 seconds in, but only until 1905 or
%so, should see if these times points are segmented out.
...
%123 T7, T8 impossibly large and noisy, maybe P and F are too, rejected
%126 is very rarely bad for sensor CP6, gone for now
...
% Jude bad channels
EEG_runICA([110,    111,112,113,   114,      115,  116,               117,  118,119,   120,121,           122,123,125,  126,     127,    128,129,    130], ...
                     {{'FC1'},{},    {},   {'C4'}, {'FC1'}, {'F8'},{'F4','Fz','C4'},{'C4'},{},    {'Fz'}, {},    {'C3','FC6'},{},   {},    {},     {'CP6'},{'CP6'},{},   {'FC1'},{}}, ...
    '/home/andrewf/Research_data/EEG/Gaborgen24_EEG_fMRI', 1, 0)
EEG_runICA([131,132,    133,134,135, 136, 139,    140,141,      142,      143], ...
                     {{},    {},        {},   {},    {},    {},    {'FC1'}, {},    {'FC1'}, {'CP1'}, {}}, ... 
    '/home/andrewf/Research_data/EEG/Gaborgen24_EEG_fMRI', 1, 0)
...
%Jude Prepro
% EEG_finishPrepro([110,    111,112,113,   114,   115,  116,         117,  118, 119,   120,121,           122,      123,125,  126,     127,           128,  129,     130], ...
%                               {[13],    [],    [],   [],       [4],    [],     [2,16],      [11],  [1,2],[8],     [4],  [4],            [1,2,11],[],    [8],    [8],     [1,3,24,29],[1,3], [1,3],    [1,28]}, ...
%                               {{'FC1'},{},    {},   {'C4'}, {'FC1'}, {'F8'},{'F4','Fz','C4'},{'C4'},{},    {'Fz'}, {},    {'C3','FC6'},{},   {},    {},     {'CP6'},{'CP6'},{},   {'FC1'},{}}, ...
%     '/home/andrewf/Research_data/EEG/Gaborgen24_EEG_fMRI',1,0,1)
% EEG_finishPrepro([131,132,    133,  134, 135, 136, 139,      140,        141,      142,      143], ...
%                               {[2],  [2,13], [1,6],[2,5],[11],[],     [14,21],[3,11,17],[4],        [],          []},...
%                               {{},    {},        {},   {},    {},    {},    {'FC1'}, {},    {'FC1'}, {'CP1'}, {}}, ... 
%     '/home/andrewf/Research_data/EEG/Gaborgen24_EEG_fMRI', 1, 0,1)
